...
import ps.wwbtraining.teacher_group1.Adapter.ShowGroupHistory;
...
public class HistoryFragment extends Fragment {
    ...
    private ShowGroupHistory showGroupAdapter;
    ...
    private void getGroup(final View view) {
        ...
        progress.setVisibility(View.VISIBLE);
        try {
            teacherApi.showGroupHistory().enqueue(new Callback<GroupModel>() {
                @Override
                public void onResponse(Call<GroupModel> call, Response<GroupModel> response) {
                    if (response.isSuccessful()) {
                        if (response.body().isResult()) {
                            ...
                            showGroupAdapter = new ShowGroupHistory(HistoryFragment.this, array);
